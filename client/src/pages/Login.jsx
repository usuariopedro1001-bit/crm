    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-zinc-500 text-[10px] font-black uppercase tracking-[0.3em] mt-3">Sua central de alta performance</p>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 p-10 rounded-[2.5rem] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)]">
          <h2 className="text-xl font-black text-white uppercase tracking-tight mb-8">Acesse sua conta</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black text-zinc-500 uppercase tracking-widest ml-1">Chave de Acesso</label>
              <div className="relative">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-5 bg-red-600 text-white rounded-2xl hover:bg-red-700 transition-all duration-300 font-black text-xs uppercase tracking-[0.2em] shadow-xl shadow-red-900/20 active:scale-95 disabled:opacity-50"
            >
              {loading ? (
          ...
          <div className="mt-10 text-center">
            <p className="text-zinc-500 text-[10px] font-black uppercase tracking-widest">
              ...
              <Link to="/signup" className="text-red-500 hover:text-red-400 transition-colors ml-1 underline underline-offset-4">
                Solicite uma conta
              </Link>
            </p>
          </div>
